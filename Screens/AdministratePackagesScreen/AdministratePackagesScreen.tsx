...
const CardBox = ({data, setSelectedPackage, handleTrashCanPress, cardBoxStyles, backgroundCardStyles}:{data: any, setSelectedPackage: any, handleTrashCanPress: any, cardBoxStyles: any, backgroundCardStyles: any}) => {
    ...
    return (
        <View style={cardBoxStyles}>
            <Background style={backgroundCardStyles} image={{uri: data?.mainImageUrl || 'data:image/jpeg;base64,'}}>
                ...
                <TouchableOpacity style={styles.secondRowCardBox} onPress={() =>{setSelectedPackage(true)}}>
    ...
    <>
        {selectedPackage && (
            ...
            <View style={stylesIndividualCard.giantSelectedCard}>
                {/* <Text>HOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO</Text> */}
    
                <View style={stylesIndividualCard.card}>
                <Background style={styles.backgroundCard} image={{uri:'data:image/jpeg;base64,'}}>
                    ...
                    <View style={stylesIndividualCard.firstRow}>
                        ...
                        <View style={stylesIndividualCard.firstRowCenter} >
                            <Text style={styles.bigText}>Público</Text>
                        </View>
                        <View style={stylesIndividualCard.firstRowRight}>
                            <TouchableOpacity style={stylesIndividualCard.firstRowRightBox} onPress={() => {setSelectedPackage(false)}}>
                                <Text>Out</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
        ...
        <View style={styles.thirdBox}>
            <ScrollView style={styles.scrollView} contentContainerStyle = {styles.scrollViewContentContainerStyle}>
                ...
                {documents.map((document, index) => (
                    <CardBox key={index} data={document} setSelectedPackage={setSelectedPackage} handleTrashCanPress={handleTrashCanPress} cardBoxStyles={styles.cardBox} backgroundCardStyles={styles.backgroundCard}/>
                ))}
