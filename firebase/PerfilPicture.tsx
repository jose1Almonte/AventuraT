...
export const ProfilePicture = ({
    ...
    return (
        <>
            {isLogged ? (
                <>
                    <TouchableOpacity style={{ width: pixelSize, height: pixelSize, alignItems: 'center' }} onPress={() => { navigation.navigate(route,{actualizaPerfil: actualizaPerfil},{setActualizaPerfil:setActualizaPerfil}); }}>
