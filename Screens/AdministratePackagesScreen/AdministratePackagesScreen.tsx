...
const CardBox = ({cardBoxStyles, backgroundCardStyles}:{cardBoxStyles: any, backgroundCardStyles: any}) => {
    return (
        <View style={cardBoxStyles}>
            <Background style={backgroundCardStyles} image={require('../../images/bonito.jpeg')}>
